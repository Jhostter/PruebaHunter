...
function _templateObject() {
  var data = _taggedTemplateLiteral(["select * from actores where nombre like '%'+", "+'%'"]);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          _db = _context.sent;
          _context.next = 5;
          return regeneratorRuntime.awrap(_db.query(_templateObject(), request.query.nombre_actor));
