...
function _templateObject() {
  var data = _taggedTemplateLiteral(["select * from actores a\n        join actores_peliculas ap on a.id=ap.actor_id\n        where ap.pelicula_id=", ""]);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          _db = _context.sent;
          _context.next = 5;
          return regeneratorRuntime.awrap(_db.query(_templateObject(), request.query.pelicula_id));
